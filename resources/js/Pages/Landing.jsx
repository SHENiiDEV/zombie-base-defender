            ...
            <main id="main-content">
                <section className="landing-hero campaign-hero" aria-labelledby="campaign-title">
                    ...
                    <div className="landing-container campaign-hero-content">
                        ...
                        <div className="hero-actions"><Link href={navigation.game} className="landing-button primary"><Crosshair size={19} /> TAKE YOUR POSITION <ArrowUpRight size={21} /></Link><a href="#about" className="hero-secondary">Explore the game <ArrowDown size={16} /></a></div>
                    ...
                    <div className="landing-container"><div className="campaign-section-heading"><div><span className="section-kicker">KNOW WHAT’S COMING</span><h2>They used to<br />be <em>human.</em></h2></div><p>Different instincts. The same hunger.<br />Learn their patterns before they reach the barricade.</p></div>
                        <div className="infected-layout">
                            <article className="infected-boss">
                                ...
                                <div className="infected-boss-copy"><span className="section-kicker">WHEN THE GROUND STARTS SHAKING</span><h3>THE<br />GOLIATH.</h3><p>Built like a siege engine.<br />And your wall is in its way.</p><div className="boss-traits"><span>HEAVY ARMOR</span><span>RELENTLESS ADVANCE</span></div><Link href={navigation.game} className="infected-challenge">Think you can hold? <ArrowUpRight size={19} /></Link></div>
                ...
                <section className="campaign-last-call"><div className="landing-container"><span className="section-kicker">NO ONE ELSE IS COMING.</span><h2>GIVE THEM<br /><em>HELL.</em></h2><p>One outpost. One defender. One more wave.</p><Link href={navigation.game} className="landing-button primary"><Crosshair size={20} /> PLAY ZOMBIE BASE DEFENDER <ArrowUpRight size={21} /></Link><span className="last-call-coordinate" aria-hidden="true">09</span></div></section>
            </main>
            <PublicFooter />
        </div>
    );
